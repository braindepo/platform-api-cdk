...
import { ITask, IEditedTask, ITasksSearchFilter, TasksSortBy } from './models';
...
export class TasksProxy extends PlatformProxy {
  ...
  async update({ externalId, ...taskInfo }: IEditedTask, authTokenData?: IAuthTokenData): Promise<void> {
